...
public class TestHyperEdgeRerouting
{
    @Test
    public void test()
    {
        ...
        poly0 = new Polygon(4);
        poly0.setPoint(0, new Point(27350, 26040));
        poly0.setPoint(1, new Point(27350, 26450));
        poly0.setPoint(2, new Point(26925, 26450));
        poly0.setPoint(3, new Point(26925, 26040));
        ...
        poly0 = new Polygon(4);
        poly0.setPoint(0, new Point(27030, 26900));
        poly0.setPoint(1, new Point(27030, 27050));
        poly0.setPoint(2, new Point(26970, 27050));
        poly0.setPoint(3, new Point(26970, 26900));
        ...
        poly0 = new Polygon(4);
        poly0.setPoint(0, new Point(26480, 26350));
        poly0.setPoint(1, new Point(26480, 26500));
        poly0.setPoint(2, new Point(26420, 26500));
        poly0.setPoint(3, new Point(26420, 26350));
        ...
        poly0 = new Polygon(4);
        poly0.setPoint(0, new Point(26860, 26900));
        poly0.setPoint(1, new Point(26860, 27050));
        poly0.setPoint(2, new Point(26790, 27050));
        poly0.setPoint(3, new Point(26790, 26900));
        ...
        JunctionRef junction0_16268769 = new JunctionRef(router0, new Point(27000, 27075), 16268769);
        junction0_16268769.setPositionFixed(true);
        JunctionRef junction0_142222080 = new JunctionRef(router0, new Point(27200, 26450), 142222080);
        junction0_142222080.setPositionFixed(true);
        JunctionRef junction0_471289251 = new JunctionRef(router0, new Point(26350, 26325), 471289251);
        junction0_471289251.setPositionFixed(true);


        end1_0 = new ConnEnd(shape0_646972128, 1);
        end2_0 = new ConnEnd(junction0_16268769);
        ConnRef conn0_64950216 = new ConnRef(router0, end1_0, end2_0, 64950216);
        end1_0 = new ConnEnd(junction0_16268769);
        end2_0 = new ConnEnd(shape0_478041183, 7);
        ConnRef conn0_278089510 = new ConnRef(router0, end1_0, end2_0, 278089510);
        end1_0 = new ConnEnd(shape0_241539284, 1);
        end2_0 = new ConnEnd(junction0_16268769);
        ConnRef conn0_41268690 = new ConnRef(router0, end1_0, end2_0, 41268690);

        end1_0 = new ConnEnd(shape0_478041183, 9);
        end2_0 = new ConnEnd(junction0_142222080);
        ConnRef conn0_60256130 = new ConnRef(router0, end1_0, end2_0, 60256130);
        end1_0 = new ConnEnd(shape0_478041183, 3);
        end2_0 = new ConnEnd(junction0_142222080);
        ConnRef conn0_73835204 = new ConnRef(router0, end1_0, end2_0, 73835204);
        end1_0 = new ConnEnd(shape0_478041183, 4);
        end2_0 = new ConnEnd(junction0_142222080);
        ConnRef conn0_93872527 = new ConnRef(router0, end1_0, end2_0, 93872527);

        end1_0 = new ConnEnd(shape0_53041512, 1);
        end2_0 = new ConnEnd(junction0_471289251);
        ConnRef conn0_448284384 = new ConnRef(router0, end1_0, end2_0, 448284384);
        end1_0 = new ConnEnd(shape0_478041183, 1);
        end2_0 = new ConnEnd(junction0_471289251);
        ConnRef conn0_392836745 = new ConnRef(router0, end1_0, end2_0, 392836745);
        end1_0 = new ConnEnd(shape0_241539284, 2);
        end2_0 = new ConnEnd(junction0_471289251);

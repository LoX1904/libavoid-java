...
public class TestCppPorttreeRootCrash02
{
    @Test
    public void testtreeRootCrash02()
    {
	...
	poly0 = new Polygon(4);
	poly0.setPoint(0, new Point(50410, 49975));
	poly0.setPoint(1, new Point(50410, 50710));
	poly0.setPoint(2, new Point(49975, 50710));
	poly0.setPoint(3, new Point(49975, 49975));
	...
	poly0 = new Polygon(4);
	poly0.setPoint(0, new Point(49535, 50540));
	poly0.setPoint(1, new Point(49535, 50650));
	poly0.setPoint(2, new Point(49415, 50650));
	poly0.setPoint(3, new Point(49415, 50540));
	...
	JunctionRef junction0_144230940 = new JunctionRef(router0, new Point(49475, 50725), 144230940);
	...
	poly0 = new Polygon(4);
	poly0.setPoint(0, new Point(50485, 49265));
	poly0.setPoint(1, new Point(50485, 49550));
	poly0.setPoint(2, new Point(50190, 49550));
	poly0.setPoint(3, new Point(50190, 49265));
	...
	poly0 = new Polygon(4);
	poly0.setPoint(0, new Point(50610, 49646));
	poly0.setPoint(1, new Point(50610, 49704));
	poly0.setPoint(2, new Point(50525, 49704));
	poly0.setPoint(3, new Point(50525, 49646));
	...
	JunctionRef junction0_24560921 = new JunctionRef(router0, new Point(50300, 49675), 24560921);
	junction0_24560921.setPositionFixed(true);
	end1_0 = new ConnEnd(shape0_145706592, 2);
	end2_0 = new ConnEnd(junction0_144230940);
	ConnRef conn0_61425638 = new ConnRef(router0, end1_0, end2_0, 61425638);
	end1_0 = new ConnEnd(junction0_144230940);
	end2_0 = new ConnEnd(shape0_368159034, 1);
	ConnRef conn0_378385232 = new ConnRef(router0, end1_0, end2_0, 378385232);
	end1_0 = new ConnEnd(new Point(49975, 50450), 15);
	end2_0 = new ConnEnd(new Point(49600, 50525), 15);
	...
	end1_0 = new ConnEnd(new Point(49600, 50650), 15);
	end2_0 = new ConnEnd(new Point(49475, 50725), 15);
	ConnRef conn0_880789055 = new ConnRef(router0, end1_0, end2_0, 880789055);
	poly0 = new Polygon(3);
	poly0.setPoint(0, new Point(49600, 50650));
	poly0.setPoint(1, new Point(49600, 50725));
	poly0.setPoint(2, new Point(49475, 50725));
	conn0_880789055.setFixedRoute(poly0);
	conn0_880789055.setSourceEndpoint(end1_0);
	conn0_880789055.setDestEndpoint(end2_0);
	end1_0 = new ConnEnd(new Point(49975, 50600), 15);
	end2_0 = new ConnEnd(new Point(49600, 50650), 15);
	...
	end1_0 = new ConnEnd(shape0_59732242, 3);
	end2_0 = new ConnEnd(junction0_24560921);
	ConnRef conn0_605306624 = new ConnRef(router0, end1_0, end2_0, 605306624);
	end1_0 = new ConnEnd(junction0_24560921);
	end2_0 = new ConnEnd(shape0_1023802233, 15);
	ConnRef conn0_61198110 = new ConnRef(router0, end1_0, end2_0, 61198110);
	end1_0 = new ConnEnd(shape0_1023802233, 19);
	end2_0 = new ConnEnd(junction0_24560921);
	ConnRef conn0_323306544 = new ConnRef(router0, end1_0, end2_0, 323306544);
	end1_0 = new ConnEnd(shape0_152071508, 1);
	end2_0 = new ConnEnd(junction0_24560921);
